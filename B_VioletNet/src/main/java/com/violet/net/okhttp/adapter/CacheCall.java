 ...
 */
package com.violet.net.okhttp.adapter;

import com.violet.net.http.callback.Callback;
import com.violet.net.http.model.Response;
import com.violet.net.http.request.Call;
import com.violet.net.http.request.Request;
import com.violet.net.okhttp.cache.CacheEntity;
import com.violet.net.okhttp.cache.policy.CachePolicy;
import com.violet.net.okhttp.cache.policy.DefaultCachePolicy;
import com.violet.net.okhttp.cache.policy.FirstCacheRequestPolicy;
import com.violet.net.okhttp.cache.policy.NoCachePolicy;
import com.violet.net.okhttp.cache.policy.NoneCacheRequestPolicy;
import com.violet.net.okhttp.cache.policy.RequestFailedCachePolicy;
 ...
 * ================================================
 */
public class CacheCall implements Call {
    ...
    public Response execute() {
        ...
        CacheEntity cacheEntity = policy.prepareCache();
    ...
    private CachePolicy preparePolicy() {
