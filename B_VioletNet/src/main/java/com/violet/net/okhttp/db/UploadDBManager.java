 ...
 */
package com.violet.net.okhttp.db;
 ...
 * ================================================
 */
public class UploadDBManager extends BaseDao<Progress> {
    ...
    private static class UploadManagerHolder {
        private static final UploadDBManager instance = new UploadDBManager();
    }
