...
import com.violet.net.http.model.MediaType;
...
//        okhttp3.MediaType mt = TranseferUtil.transferFileParam(mediaType);
//        if (content != null && mediaType != null) return RequestBody.create(mt, content);    //上传字符串数据
//        if (bs != null && mediaType != null) return RequestBody.create(mt, bs);              //上传字节数组
//        if (file != null && mediaType != null) return RequestBody.create(mt, file);          //上传一个文件
